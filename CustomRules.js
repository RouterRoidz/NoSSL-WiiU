...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeRequest(oSession: Session) {
        if (oSession.uriContains("account.nintendo.net")) {
            oSession["https-Client-Certificate"] = "C:\\WIIU\\account.cer";
        } else if (oSession.uriContains("nintendo.net")) {
            oSession["https-Client-Certificate"] = "C:\\WIIU\\common.cer";
        }
